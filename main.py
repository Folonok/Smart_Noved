...
class NoteWidget(QMainWindow):
    ...
    def connects(self):
        ...
        self.ui.pushButton_5.clicked.connect(self.save_note)
        self.ui.pushButton_6.clicked.connect(self.del_note)
    def read_notes(self):
        try:
    ...
    def save_note(self):
        ...
        self.save_file()
        self.ui.lineEdit.clear()
        self.ui.lineEdit.addItems(self.notes)

    def del_note(self):
         title = self.ui.lineEdit.text()
         if title in self.notes[title]:
